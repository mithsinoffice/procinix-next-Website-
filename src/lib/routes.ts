...
export const MODULE_ROUTES = {
  ...
  vendorAdvances: {
    path: "/modules/vendor-advances",
    label: "Vendor Advances",
    title: "Vendor Advance Payment Management",
    description: "Vendor advance payment software — advance request and approval workflow, automatic adjustment against incoming invoices, and audit-ready reconciliation.",
    keywords: ["vendor advance payment", "vendor advance management", "supplier advance tracking", "advance adjustment against invoices", "vendor advance reconciliation"],
    group: "module",
    family: "s2p",
  },
  vendorPortal: {
    path: "/modules/vendor-portal",
    label: "Vendor Portal",
    title: "Vendor Self-Service Portal",
    description: "Vendor self-service portal — real-time invoice and payment status, PO acknowledgment, and secure document upload for suppliers.",
    keywords: ["vendor portal software", "supplier self-service portal", "vendor management portal", "vendor payment status portal", "supplier portal"],
    group: "module",
    family: "s2p",
  },
  inventoryManagement: {
    path: "/modules/inventory-management",
    label: "Inventory Management",
    title: "Inventory Management Automation",
    description: "Inventory management automation — GRN-to-ledger sync, multi-location stock visibility, automated valuation, and physical-to-book reconciliation.",
    keywords: ["inventory management software", "inventory module", "inventory automation", "stock reconciliation", "GRN automation", "inventory valuation", "multi-location inventory"],
    group: "module",
    family: "s2p",
  },
  vendorOnboarding: {
    path: "/modules/vendor-onboarding",
    label: "Vendor Onboarding & KYC",
    title: "Vendor Onboarding & KYC Automation",
    description: "Vendor onboarding automation — self-service portal, configurable KYC and compliance workflows, document tracking, and vendor master governance.",
    keywords: ["vendor onboarding software", "supplier onboarding software", "vendor onboarding automation", "vendor KYC verification", "supplier due diligence", "vendor compliance validation", "vendor master data governance"],
    group: "module",
    family: "s2p",
  },
  // O2C
  ...
  indAs116LeaseAccounting: {
    path: "/modules/ind-as-116-lease-accounting",
    label: "Ind AS 116 Lease Accounting",
    title: "Ind AS 116 Lease Accounting Software",
    description: "Ind AS 116 (and IFRS 16) lease accounting software — automated right-of-use asset and lease liability schedules, modifications, and audit-ready disclosures.",
    keywords: ["Ind AS 116", "Ind AS 116 lease accounting software", "IFRS 16 lease accounting", "right of use asset software", "lease liability schedule", "ROU asset amortization"],
    group: "module",
    family: "r2r",
  },
  prepaidAutomation: {
    path: "/modules/prepaid-automation",
    label: "Prepaid Automation",
    title: "Prepaid Expense Automation",
    description: "Prepaid expense amortization software — contract-to-schedule automation for insurance, subscriptions, retainers, and licenses.",
    keywords: ["prepaid expense automation", "prepaid amortization software", "prepaid expense management", "prepaid schedule automation"],
    group: "module",
    family: "r2r",
  },
  yearEndClose: {
  ...
  bankReconciliation: {
    path: "/modules/bank-reconciliation",
    label: "Bank Reconciliation",
    title: "Bank Reconciliation Automation",
    description: "Bank reconciliation automation — auto-imported statements, rule-based and AI transaction matching, and multi-bank, multi-entity exception handling.",
    keywords: ["bank reconciliation software", "bank reconciliation automation", "automated bank reconciliation", "transaction matching", "multi-bank reconciliation"],
    group: "module",
    family: "r2r",
  },
} satisfies Record<string, RouteDef>;
